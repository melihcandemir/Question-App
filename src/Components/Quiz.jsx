  ...
  function handleAnswer(option) {
    ...
    setAnswerList((prev) => [
      ...prev,
      {
        ...
        selected: option,
        correct: option === qurrentQuestion.answer,
      },
    ]);
    ...
    return (
      ...
      <div className="result">
        ...
        <div className="result-div">
          ...
          <p>
            Yanlış: {answerList.filter((a) => a.selected && !a.correct).length}
          </p>
            ...
            {questions.map((q, index) => {
              ...
              return (
                ...
                >
                  {/* Soru metni */}
                  <p>
                    <strong>{index + 1}. Soru:</strong> {q.question}
                  </p>
                  {/* Kullanıcının verdiği cevap */}
                  <p>
                    <strong>Verdiğiniz Cevap:</strong> {userAnswer}
                  </p>
                  {/* Doğru cevap */}
                  <p>
